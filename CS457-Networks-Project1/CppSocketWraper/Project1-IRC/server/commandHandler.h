...
class commandHandler{
    public:
        commandHandler(tcpServerSocket s, shared_ptr<vector<shared_ptr<channel>>> chlist);
        ...
        vector<shared_ptr<channel>>::iterator getChannel(string channelName);
    ...
    private:
        ...
        shared_ptr<vector<shared_ptr<channel>>> channelList;
